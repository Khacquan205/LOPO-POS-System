// Ưu tiên đọc từ mobile/.env (EXPO_PUBLIC_API_BASE_URL) để không phải sửa tay trong code.
// Ví dụ: EXPO_PUBLIC_API_BASE_URL=http://192.168.1.10:3000/api
const envApiBaseUrl = process.env.EXPO_PUBLIC_API_BASE_URL?.trim();
const defaultApiBaseUrl = "http://10.0.2.2:3000/api";

// Bỏ dấu / cuối nếu có để khi ghép với path không bị //
